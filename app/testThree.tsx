...
export default function AnimatedScreen() {
  ...
  return (
    <>
        ...
        <View className=" items-center">
          ...
          {showCard && (
            <Animated.View
              ...
              className="bg-white w-[91%] p-2 rounded-[17px] mt-4 py-6 px-4 mb-4"
            >
      ...
      >
        <Pressable
          className="w-[91%] h-[60%] bg-[#0D61FD] border border-[#0D61FD]  rounded-xl md:rounded-xl items-center justify-center"
          onPress={handletoGoHome}
        >
